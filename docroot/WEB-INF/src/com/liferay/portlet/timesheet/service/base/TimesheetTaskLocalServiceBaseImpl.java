...
/**
 * The base implementation of the timesheet task local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.portlet.timesheet.service.impl.TimesheetTaskLocalServiceImpl}.
 * </p>
 *
 * @author Mate Thurzo
...
public abstract class TimesheetTaskLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.portlet.timesheet.service.TimesheetTaskLocalServiceUtil} to access the timesheet task local service.
	 */
	...
	public TimesheetTask addTimesheetTask(TimesheetTask timesheetTask)
		...
		return timesheetTaskPersistence.update(timesheetTask, false);
	}
	 ...
	 */
	public TimesheetTask createTimesheetTask(long taskId) {
		return timesheetTaskPersistence.create(taskId);
	}
	...
	public TimesheetTask deleteTimesheetTask(long taskId)
		throws PortalException, SystemException {
		return timesheetTaskPersistence.remove(taskId);
	}
	...
	public TimesheetTask fetchTimesheetTask(long taskId)
		throws SystemException {
		return timesheetTaskPersistence.fetchByPrimaryKey(taskId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TimesheetTask getTimesheetTask(long taskId)
		throws PortalException, SystemException {
		return timesheetTaskPersistence.findByPrimaryKey(taskId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getTimesheetTasksCount() throws SystemException {
	...
	public TimesheetTask updateTimesheetTask(TimesheetTask timesheetTask)
		throws SystemException {
		return updateTimesheetTask(timesheetTask, true);
	}
	...
	public TimesheetTask updateTimesheetTask(TimesheetTask timesheetTask,
		...
		return timesheetTaskPersistence.update(timesheetTask, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.portlet.timesheet.model.TimesheetTask",
	...
	private TimesheetTaskLocalServiceClpInvoker _clpInvoker = new TimesheetTaskLocalServiceClpInvoker();
}