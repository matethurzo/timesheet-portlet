...
/**
 * The utility for the timesheet task local service. This utility wraps {@link com.liferay.portlet.timesheet.service.impl.TimesheetTaskLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
 ...
 * @see com.liferay.portlet.timesheet.service.impl.TimesheetTaskLocalServiceImpl
 * @generated
 */
public class TimesheetTaskLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.portlet.timesheet.service.impl.TimesheetTaskLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.liferay.portlet.timesheet.model.TimesheetTask addTimesheetTask(
	...
	*/
	public static com.liferay.portlet.timesheet.model.TimesheetTask createTimesheetTask(
		long taskId) {
		return getService().createTimesheetTask(taskId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.liferay.portlet.timesheet.model.TimesheetTask deleteTimesheetTask(
		long taskId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteTimesheetTask(taskId);
	}
	...
	*/
	public static com.liferay.portlet.timesheet.model.TimesheetTask deleteTimesheetTask(
		com.liferay.portlet.timesheet.model.TimesheetTask timesheetTask)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteTimesheetTask(timesheetTask);
	}
	...
	*/
	...
	public static com.liferay.portlet.timesheet.model.TimesheetTask fetchTimesheetTask(
		long taskId) throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchTimesheetTask(taskId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.liferay.portlet.timesheet.model.TimesheetTask getTimesheetTask(
		long taskId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getTimesheetTask(taskId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.liferay.portlet.timesheet.model.TimesheetTask> getTimesheetTasks(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getTimesheetTasks(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getTimesheetTasksCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getTimesheetTasksCount();
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.liferay.portlet.timesheet.model.TimesheetTask updateTimesheetTask(
		com.liferay.portlet.timesheet.model.TimesheetTask timesheetTask)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateTimesheetTask(timesheetTask);
	}
	...
	*/
	public static com.liferay.portlet.timesheet.model.TimesheetTask updateTimesheetTask(
		...
		boolean merge)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateTimesheetTask(timesheetTask, merge);
	}
	...
	*/
	...
	public static TimesheetTaskLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					TimesheetTaskLocalService.class.getName());

			if (invokableLocalService instanceof TimesheetTaskLocalService) {
				_service = (TimesheetTaskLocalService)invokableLocalService;
			}
			else {
				_service = new TimesheetTaskLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(TimesheetTaskLocalServiceUtil.class,
				"_service");
		}
	 ...
	 * @deprecated
	 */
	public void setService(TimesheetTaskLocalService service) {
	}

	private static TimesheetTaskLocalService _service;
}